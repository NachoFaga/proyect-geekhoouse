  ...
  if (items.length === 0) {
    navigateModal
      .fire({
        ...
        html: <h5>Volviendo a la tienda</h5>,
    ...
    return (
      <div className="purchase__container">
        <div className="checkout">
          <div className="brand">
            <img src={logo} alt="Brand main logo" className="brand__logo" />
          </div>
          <div className="contact">
            <div className="contact__information">
              <h1 className="contact__title">Completa los datos para finalizar la compra</h1>
              <CheckoutForm id={orderId} setId={setOrderId} />
            </div>
          </div>
        </div>
        <div className="summary">
          <h1 className="summary__title">Detalle</h1>
          <Divider />
